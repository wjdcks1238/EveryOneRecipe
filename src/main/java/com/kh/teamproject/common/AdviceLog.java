package com.kh.teamproject.common;
...
public class AdviceLog {
	...
	// .. 0개 이상이 종류 상관 없이 존재함
	//                                           ~Controller
	@Pointcut("execution(public * com.kh.teamproject..*Controller.*(..) )")
	public void controllerPointCut() {}
	// 위 pointcut의 이름은 "controllerPointCut()" 
	
	@Pointcut("execution(public * com.kh.teamproject..*Dao.*(..) )")
	public void daoPointCut() {}
	
	@Pointcut("execution(public * com.kh.teamproject..*ServiceImpl.*(..) )")
