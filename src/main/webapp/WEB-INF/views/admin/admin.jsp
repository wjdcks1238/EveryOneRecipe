...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<%=request.getContextPath()%>/resources/sbadmin2/pages/index.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<%=request.getContextPath()%>/admin/members">직원등록</a>
                        <a class="collapse-item" href="<%=request.getContextPath()%>/admin/members">직원수정</a>                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<%=request.getContextPath()%>/resources/sbadmin2/pages/utilities-color.html">검색어 순위</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<%=request.getContextPath()%>/resources/sbadmin2/pages/charts.html">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<%=request.getContextPath()%>/resources/sbadmin2/pages/tables.html">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<%=request.getContextPath()%>/resources/sbadmin2/pages/login.html">Logout</a>
                </div>
            </div>
        </div>
    </div>
