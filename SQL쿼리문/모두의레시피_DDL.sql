...
CREATE TABLE "SEARCHDB" (
	...
	"KEWORD"	VARCHAR2(30 CHAR)		NOT NULL,
	"SEARCHDATE"	TIMESTAMP	DEFAULT SYSTIMESTAMP	NOT NULL,
...
ALTER TABLE "SEARCHDB" ADD CONSTRAINT "FK_SEARCH_TO_SEARCHDB_1" FOREIGN KEY (
	"KEWORD"
)
REFERENCES "SEARCH" (
	"KEWORD"
...
CREATE TABLE "MEMBERS" (
	...
	"ISBLOCKED"	CHAR(1)	DEFAULT 'N'	NULL
);
